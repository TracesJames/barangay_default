    ...
    <section class="content">
      <div class="container-fluid">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body ">
              <form id="reportFilterForm" method="get" action="report.php" onsubmit="return false;">
                <div class="row">
                  <div class="col-sm-4">
                  ...
                  <div class="col-sm-12 text-center ">
                    <button type="button" class="btn btn-flat bg-info px-3 elevation-3 text-white" id="search"><i class="fas fa-filter"></i> FILTER</button>
                    <a href="report.php" class="btn btn-flat btn-danger px-3 elevation-3" id="reset"><i class="fas fa-undo"></i> RESET</a>
                  </div>
                  </form>
                </div>
                <div class="form-group">
                <a href="printReport.php" id="printReportLink" target="_blank" class="btn btn-warning btn-flat elevation-5 px-3" ><i class="fas fa-print"></i> PRINT</a>
  ...
  $(document).ready(function(){
    ...
    function reportFilters() {
      return {
        ...
        status: $('#status').val(),
        pwd: $('#pwd').val(),
        single_parent: $('#single_parent').val(),
        senior: $('#senior').val()
      };
    }

    function updatePrintLink() {
      var params = $.param(reportFilters());
      $('#printReportLink').attr('href', 'printReport.php' + (params ? '?' + params : ''));
    }
    ...
    $('#voters, #status, #pwd, #single_parent, #senior').on('change', updatePrintLink);
