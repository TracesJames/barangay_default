...
<head>
  ...
  <title>New Resident — <?= barangay_h($barangay) ?></title>
      ...
      <div class="container-fluid">
        <div class="card card-outline card-indigo elevation-2 mb-4 nr-page-hero">
          <div class="card-body text-center py-4">
            <img src="<?= barangay_h($sidebarLogo) ?>" alt="<?= barangay_h($barangay) ?>" class="img-circle mb-2" style="width:72px;height:72px;object-fit:cover;border:3px solid rgba(102,16,242,.2);background:#fff;">
            <h4 class="mb-0"><?= barangay_h($barangay) ?></h4>
            ...
            <p class="text-muted small mb-3">Fill in the tabs below. Required fields are marked with <span class="text-danger">*</span>. A residence number is assigned automatically on save.</p>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group ">
                      ...
                      <input type="text" class="form-control" id="add_birth_place" name="add_birth_place" placeholder="City / Municipality">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group ">
                  ...
                  <div class="col-sm-12" id="pwd_check" style="display: none;">
                    <div class="form-group ">
                      <label class="nr-required">Type of PWD</label>
                        <input type="text" class="form-control" id="add_pwd_info" name="add_pwd_info" placeholder="e.g. Visual, Mobility">
                    </div>
                  </div>
                  <div class="col-sm-12">
                    <div class="form-group ">
...
<script>
  $(document).ready(function(){
    ...
    $("#add_first_name, #add_last_name").keyup(function(){
      if (window.barangayNewResidence && barangayNewResidence.syncPreviewName) {
        barangayNewResidence.syncPreviewName();
      } else {
