...
// Nutrition Portal accounts stay inside Nutrition Hub only.
if (isset($_SESSION['user_id']) && barangay_user_is_nutrition_scoped_account($con, (string) $_SESSION['user_id'])) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <form id="changeProfile" method="post" enctype="multipart/form-data">
            ...
            <?php require __DIR__ . '/../includes/partials/appearance_accessibility_panel.php'; ?>
