...
if ($category === 'children') {
    $whereClause[] = barangay_children_age_condition('residence_information');
} elseif ($category === 'indigenous' && barangay_column_exists($con, 'residence_status', 'indigenous')) {
    $whereClause[] = "residence_status.indigenous='YES'";
}
