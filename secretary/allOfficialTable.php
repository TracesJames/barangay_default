...
try {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $subdata[] = $voters;
        $subdata[] = $status;
        $subdata[] = '<a href="viewOfficial.php?official_id=' . barangay_h((string) $row['official_id']) . '" style="cursor: pointer;  color: yellow;  text-shadow: -1px 0 black, 0 1px black, 1px 0 black, 0 -1px black;" class="fa fa-user-edit text-lg px-3 "></a>
   ';
        $data[] = $subdata;
    }
