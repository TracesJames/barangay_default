...
if (barangay_column_exists($con, 'users', 'barangay_id')) {
    ...
    $stmt_user->bind_param('sssssssssss', $number, $add_first_name, $add_middle_name, $add_last_name, $number, $password, $user_type_resident, $add_contact_number, $new_image_name, $new_image_path, $barangay_id);
} else {
    ...
    $stmt_user->bind_param('ssssssssss', $number, $add_first_name, $add_middle_name, $add_last_name, $number, $password, $user_type_resident, $add_contact_number, $new_image_name, $new_image_path);
}
$stmt_user->execute();
$stmt_user->close();
...
barangay_audit_log(
    $con,
    strtoupper('SECRETARY') . ': ADDED RESIDENT - ' . $number . ' |  ' . $add_first_name . ' ' . $add_last_name . ' ' . $add_suffix,
    'create',
    [
